...
public class Industry_Commercial extends BaseTest {
	...
	@Test()
	public void industry_Commercial(String policyName, String assertPolicyName, String name, String phone,
		...
		boolean status = organisations.clickMalls();

		if (status == true) {

			test.log(LogStatus.PASS, "Successfully clicked Commercial Spaces Industry");

		} else {

			test.log(LogStatus.FAIL, "Failed to click Commercial Spaces Industry");

			Assert.assertTrue(false);
		}

		test.log(LogStatus.PASS, "Successfully navigated to Commercial Spaces Industry");
