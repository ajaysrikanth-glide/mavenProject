...
public class Industry_Renewable extends BaseTest {
	...
	public void industry_Renewable(String policyName, String assertPolicyName, String name, String phone, String company,
			...
			boolean status = organisations.clickRenewable();

			if (status == true) {

				test.log(LogStatus.PASS, "Successfully clicked Renewable Energy Industry");

			} else {

				test.log(LogStatus.FAIL, "Failed to click Renewable Energy Industry");
				
				Assert.assertTrue(false);
			}

			test.log(LogStatus.PASS, "Successfully navigated to Renewable Energy Industry");
