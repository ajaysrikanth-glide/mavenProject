...
public class Industry_PvtJets extends BaseTest {
	...
	@Test()
	public void industry_PvtJets(String policyName, String assertPolicyName, String name, String phone, String company,
			...
			boolean status = organisations.clickPvtJets();

			if (status == true) {

				test.log(LogStatus.PASS, "Successfully clicked Pvt Jets & Helicopters Industry");

			} else {

				test.log(LogStatus.FAIL, "Failed to click Pvt Jets & Helicopters Industry");
				
				Assert.assertTrue(false);
			}

			test.log(LogStatus.PASS, "Successfully navigated to Pvt Jets & Helicopters Industry");
