...
public class Industry_Manufacturing extends BaseTest {
	...
	@Test()
	public void industry_Manufacturing(String policyName, String assertPolicyName, String name, String phone, String company,
			...
			boolean status = organisations.clickManufacturing();

			if (status == true) {

				test.log(LogStatus.PASS, "Successfully clicked Manufacturing & MSME Industry");

			} else {

				test.log(LogStatus.FAIL, "Failed to click Manufacturing & MSME Industry");
				
				Assert.assertTrue(false);
			}

			test.log(LogStatus.PASS, "Successfully navigated to Manufacturing & MSME Industry");
