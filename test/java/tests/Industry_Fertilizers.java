...
public class Industry_Fertilizers extends BaseTest {
	...
	@Test()
	public void industry_Fertilizers(String policyName, String assertPolicyName, String name, String phone, String company,
			...
			boolean status = organisations.clickFertilizers();

			if (status == true) {

				test.log(LogStatus.PASS, "Successfully clicked Fertilizers & Seeds Industry");

			} else {

				test.log(LogStatus.FAIL, "Failed to click Fertilizers & Seeds Industry");
				
				Assert.assertTrue(false);
			}

			test.log(LogStatus.PASS, "Successfully navigated to Fertilizers & Seeds Industry");
