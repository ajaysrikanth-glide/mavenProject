...
public class Industry_Shipment extends BaseTest {
	...
	@Test()
	public void industry_Shipment(String policyName, String assertPolicyName, String name, String phone, String company,
			...
			boolean status = organisations.clickShipment();

			if (status == true) {

				test.log(LogStatus.PASS, "Successfully clicked Shipment & Logistics Industry");

			} else {

				test.log(LogStatus.FAIL, "Failed to click Shipment & Logistics Industry");
				
				Assert.assertTrue(false);
			}

			test.log(LogStatus.PASS, "Successfully navigated to Shipment & Logistics Industry");
