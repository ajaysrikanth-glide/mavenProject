...
public class Industry_Others extends BaseTest {
	...
	@Test()
	public void industry_Others(String policyName, String assertPolicyName, String name, String phone, String company,
			...
			boolean status = organisations.clickOthers();

			if (status == true) {

				test.log(LogStatus.PASS, "Successfully clicked Others Industry");

			} else {

				test.log(LogStatus.FAIL, "Failed to click Others Industry");
				
				Assert.assertTrue(false);
			}

			test.log(LogStatus.PASS, "Successfully navigated to Others Industry");
