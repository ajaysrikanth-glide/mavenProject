...
public class Industry_Hospitals extends BaseTest {
	...
	@Test()
	public void industry_Hospitals(String policyName, String assertPolicyName, String name, String phone, String company,
			...
			boolean status = organisations.clickHospitals();

			if (status == true) {

				test.log(LogStatus.PASS, "Successfully clicked Hospitals Industry");

			} else {

				test.log(LogStatus.FAIL, "Failed to click Hospitals Industry");
				
				Assert.assertTrue(false);
			}

			test.log(LogStatus.PASS, "Successfully navigated to Hospitals Industry");
