...
public class Industry_Construction extends BaseTest {
	...
	@Test()
	public void industry_Construction(String policyName, String assertPolicyName, String name, String phone,
			String company, String message) throws InterruptedException {
		...
		boolean status = organisations.clickConstruction();

		if (status == true) {

			test.log(LogStatus.PASS, "Successfully clicked Construction & Infrastructure Industry");

		} else {

			test.log(LogStatus.FAIL, "Failed to click Construction & Infrastructure Industry");

			Assert.assertTrue(false);
		}

		test.log(LogStatus.PASS, "Successfully navigated to Construction & Infrastructure Industry");
