...
public class Industry_Pharma extends BaseTest {
	...
	@Test()
	public void industry_Pharma(String policyName, String assertPolicyName, String name, String phone, String company,
			...
			boolean status = organisations.clickPharma();

			if (status == true) {

				test.log(LogStatus.PASS, "Successfully clicked Pharma Industry");

			} else {

				test.log(LogStatus.FAIL, "Failed to click Pharma Industry");
				
				Assert.assertTrue(false);
			}

			test.log(LogStatus.PASS, "Successfully navigated to Pharma Industry");
