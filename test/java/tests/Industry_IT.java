...
public class Industry_IT extends BaseTest {
	...
	public void industry_IT(String policyName, String assertPolicyName, String name, String phone, String company,
		...
		boolean status = organisations.clickIT();

		if (status == true) {

			test.log(LogStatus.PASS, "Successfully clicked IT & Software Industry");

		} else {

			test.log(LogStatus.FAIL, "Failed to click IT & Software Industry");

			Assert.assertTrue(false);
		}

		test.log(LogStatus.PASS, "Successfully navigated to IT & Software Industry");
