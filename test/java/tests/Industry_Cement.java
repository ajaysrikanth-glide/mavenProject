...
public class Industry_Cement extends BaseTest {
	...
	@Test()
	public void industry_Cement(String policyName, String assertPolicyName, String name, String phone, String company,
			...
			boolean status = organisations.clickCement();

			if (status == true) {

				test.log(LogStatus.PASS, "Successfully clicked Cement Industry");

			} else {

				test.log(LogStatus.FAIL, "Failed to click Cement Industry");
				
				Assert.assertTrue(false);
			}

			test.log(LogStatus.PASS, "Successfully navigated to Cement Industry");
