...
public class AboutUs extends wrappers {
	...
	public void clickAboutUsTab() {
		...
		Assert.assertEquals(driver.getCurrentUrl().endsWith("about-us"), true);
	...
	public boolean fillJoinUsToday(String name, String phone, String email, String message) {
